...
1. If @REVIEW_PLAN.md does not exist, this is the first iteration. Run `bun run test` and `bun run typecheck` to establish baseline. Then spawn 4 parallel Opus subagents with Ultrathink to triage the codebase:
